...
@section('content')
<div class="container">
<h2 style="text-align:center;">Assign DataRoom</h2>
<div> {{ Form::open(array('url' => 'dataroom/saveshare')) }}
  <input type="hidden" name="addDataRoom" value="{{$data['roomID']}}" class="form-control">
  DataRoom:: <b>{{$data['roomName']}}</b> </br>
  ...
  <select class="list-select-box" name="dataRoomRole" id="Role" required>
    ...
    <option value="downlod">Downlod</option>
  </select>
  </br>
  </br>
  <div>
