...
<div id="client-room" class="main content">
        ...
        <div id="client-room" class="add-room">
            ...
            <div class="room">
                ...
                <h2><strong>Update</strong> Room</h2>
                ...
                <div class="content content-form">
					...
					<input type="text" id="dataRoom" name="dataRoom" value="{{$data['name']}}" placeholder="Data Room Name" required> 
                    <h3>Description</h3>
                ...
                <div class="content content-form">
                    ...
                    <h3>Company URL</h3>
                    <input type="text" name="company" placeholder="www.youcompany.com" value="{{$data['company']}}">
                    <h3>Restrict Domain (if necessary)</h3>
                    <input type="text" name="domain_restrict" placeholder="@yoursite.com" value="{{$data['domain']}}">
                ...
                <div class="section-bottom">
					...
					<?php if($data['photo']){?>
                    <img src="{{URL::asset('uploads/'.$data['photo'])}}" id="dataroomlogo" height="50" width="50" style="float:left;">
					<?php } else { ?>
...
{{ Form::close() }}
 ...
 $(document).ready(function () {
     $( "#names" ).autocomplete({
      source: URL+"/dataroom/updaterusernames",
    });
