    ...
    <tr>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="800" style="border-collapse: collapse;border:1px solid #FF9300;">
            ...
            <td width="500" bgcolor="FF9300" style="padding-left:10px;">
                <h2 style="color:#fff;font-family: 'Oswald', sans-serif;">User name : - {{$username}} </h2>
				<h4 style="color:#fff;font-family: 'Oswald', sans-serif;">Passowrd : - 'Pass@123' </h2>
            ...
            <tr>
                <td colspan="2" style="padding:5px;color:#757575;padding-top:30px;font-family: 'Quattrocento Sans', sans-serif;">You are inviting to access dataroom. Your login access are given below. Please click on the given link to access your login</td>
            </tr>
            <tr>
