<script type="text/javascript">
    $(document).ready(function() {
        $('#terms-modal-opener').trigger('click');
    })
</script>
<button type="button" id="terms-modal-opener" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="display: none;" {{(!empty($projects) ? '' : 'data-backdrop="static"')}}>
    Launch demo modal
</button>  
<!-- Modal -->
<div class="modal fade" id="myModal" tabindex="-1" data-keyboard="false" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" onclick="sessionStart()">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="col-md-1 modal-header-image">
                        <img class="round landing-profile-img" src="{{$user_profile_pic}}" /> 
                </div>
            </div>
            <div class="row landing-pop-up">
                <div class="col-lg-6 modal-body-left">
                    <div id="project-list">
                        <div class="modal-body">
                        <h3> User Agreement</h3>
						<h3>OVERVIEW</h3>
						<p>This website is operated by Ravabe.com. Throughout the site, the terms “we”, “us” and “our” refer to Ravabe.com. Ravabe.com offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
						...
						You understand that some of your content (not including credit card information), may on occasion be transferred unencrypted and involve (a) transmissions over various networks; and (b) changes to conform and adapt to technical requirements of connecting networks or devices. Credit card information is always encrypted during transfer over networks.
						...
						You agree that your comments will not violate any right of any third-party, including copyright, trademark, privacy, personality or other personal or proprietary right. You further agree that your comments will not contain libelous or otherwise unlawful, abusive or obscene material, or contain any computer virus or other malware that could in any way affect the operation of the Service or any related website. You may not use a false e-mail address, pretend to be someone other than yourself, or otherwise mislead us orthird-parties as to the origin of any comments. You are solely responsible for any comments you make and their accuracy. We take no responsibility and assume no liability for any comments posted by you or any third-party.</p>


						<h3>SECTION 11 - INFORMATION PROTECTION AND USAGE POLICY</h3>
						<p>This policy applies to Ravabe and its websites and products.
						...
						We do not share any personal information. However, some information you enter on this website may be shared with our collaborators and partners.
						...
						We and our third-party partners may collect and use Other Information in a variety of ways, including:
						...
						In no case shall Ravabe.com, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.</p>

						<h3>SECTION 15 - INDEMNIFICATION</h3>
						<p>You agree to indemnify, defend and hold harmless Ravabe.com and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
						...
						<p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws ofHongkong.</p>
						...
						<p>Questions about the Terms of Service should be sent to us at customer-service@ravabe.com.</p> 
                        </div>
                    </div>
                </div>
            </div>
