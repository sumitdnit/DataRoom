    ...
    <tr>
        ...
        <table align="center" border="0" cellpadding="10" cellspacing="10" width="800" style="border-collapse: collapse;border:1px solid #1279B2;">
            ...
            <td bgcolor="1279B2" style="padding-left:10px;">
                <h2 style="text-transform:uppercase;color:#fff;font-family: 'Oswald', sans-serif;"> FILE SHARED ON DATAROOM </h2>
								</h2>
                <h4 style="color:#fff;font-family: 'Quattrocento Sans', sans-serif;"> A file is shared on dataroom.</h4>
            </td>
            </tr>
            <tr>
