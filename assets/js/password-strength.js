(function ($) {
    ...
    var options = {
        ...
        setProgressBar = function ($el, score) {
            ...
            if (options.showVerdicts) {
                if (options.viewports.verdict) {
                    ...
                    if ($verdict.length === 0) {
                        $verdict = $('<span class="password-verdict" style="display:none;"></span>');
        ...
        progressWidget = function () {
            return '<div class="progress strengthmeter"><div class="bar progress-bar"></div></div>';
        },
            ...
            init: function (settings) {
                ...
                return this.each(function (idx, el) {
                    ...
                    if (allOptions.showVerdicts) {
                        verdict = $('<span class="password-verdict" style="display:none;">' + allOptions.verdicts[0] + '</span>');
